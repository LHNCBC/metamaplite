...
public class TokenBasedReferenceTrieTest {
    ...
    t.insert(Tokenize.mmPosTokenize("fas ligand",  0), Integer.valueOf(356));
    t.insert(Tokenize.mmPosTokenize("dopamine d1 receptor", 0), Integer.valueOf(33007));
    ...
    t.insert(Tokenize.mmPosTokenize("dopamine beta-hydroxylase (dopamine beta-monooxygenase)", 0), Integer.valueOf(1621));
