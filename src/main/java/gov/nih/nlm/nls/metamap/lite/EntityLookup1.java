 ...
 *
 */
public class EntityLookup1 {
  private static final Logger logger = LogManager.getLogger(EntityLookup1.class);
  int resultLength = 
  ...
  public static EntityLookup1 singleton;
  static {
    try {
      singleton = new EntityLookup1();
    ...
    throws FileNotFoundException, IOException, ParseException
 {
    ...
    throws FileNotFoundException, IOException, ParseException
  {
	...
	if (CharUtils.isAlpha(term.charAt(0))) {
	  ...
	  if (EntityLookup1.termConceptCache.containsKey(normTerm)) {
	    for (ConceptInfo concept: EntityLookup1.termConceptCache.get(normTerm)) {
    ...
    throws IOException, FileNotFoundException, ParseException
  {
    ...
    EntityLookup1 entityLookup = EntityLookup1.singleton;
