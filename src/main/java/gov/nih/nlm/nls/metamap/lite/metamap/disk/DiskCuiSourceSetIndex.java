...
/**
 * Describe class DiskCuiSourceSetIndex here.
 *
 *
 ...
 * @version 1.0
 */
public class DiskCuiSourceSetIndex {
  ...
  /**
   * Creates a new <code>DiskCuiSourceSetIndex</code> instance.
   * @param mmIndexes container for metamap lite indexes
   */
  public DiskCuiSourceSetIndex(MetaMapIvfDiskIndexes mmIndexes)
  {
