...
public class BioCEntityLookup 
{
   ...
   */
  public BioCEntityLookup(Properties properties)
    throws IOException, FileNotFoundException
  {
   ...
   */
  public BioCEntityLookup(Properties properties, SentenceAnnotator sentenceAnnotator)
    throws IOException, FileNotFoundException
  {
    this.mmIndexes = new MetaMapIvfIndexes(properties);
  ...
  public BioCSentence findLongestMatch(String docid, BioCSentence tokenizedSentence)
    throws FileNotFoundException, IOException
  {
  ...
  public BioCSentence processSentence(BioCSentence sentence,
    ...
    throws IOException, FileNotFoundException {
    BioCSentence annotatedSentence = this.findLongestMatch(docid, sentence);
    return annotatedSentence;
  }
}
