...
/**
 * Describe class DiskCuiPreferredNameCache here.
 *
 *
 ...
 * @version 1.0
 */
public class DiskCuiPreferredNameCache {
  ...
  boolean enableDiskCuiPreferredNameCache =
  ...
  /**
   * Creates a new <code>DiskCuiPreferredNameCache</code> instance.
   *
   * @param lookupImpl set of inverted file indexes
   */
  public DiskCuiPreferredNameCache(PreferredNameLookup lookupImpl) {
   ...
   */
  public DiskCuiPreferredNameCache(PreferredNameLookup lookupImpl, Properties properties) {
    this.lookupImpl = lookupImpl;
  }
  ...
  public String findPreferredName(String cui)
    throws FileNotFoundException, IOException
  {
    if (enableDiskCuiPreferredNameCache) {
