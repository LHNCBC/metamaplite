 ...
 * @version 1.0
 */
public class IVFTermInfoLookup implements MMLDictionaryLookup<TermInfo> {
  private static final Logger logger = LogManager.getLogger(IVFTermInfoLookup.class);
  ...
  /**
   * Creates a new <code>IVFTermInfoLookup</code> instance.
   *@param properties MetaMapLite properties instance.
   */
  public IVFTermInfoLookup(Properties properties) {
    init(properties);
  }
