...
MMLPROPS="-Dopennlp.en-sent.bin.path=$OPENNLP_MODELS/en-sent.bin \
    ...
    -Dmetamaplite.ivf.cuiconceptindex=$PROJECTDIR/data/ivf/2018AA/USAbase/strict/indices/cuiconcept \
    -Dmetamaplite.ivf.firstwordsofonewideindex=$PROJECTDIR/data/ivf/2018AA/USAbase/strict/indices/first_words_of_one_WIDE \
    -Dmetamaplite.ivf.cuisourceinfoindex=$PROJECTDIR/data/ivf/2018AA/USAbase/strict/indices/cuisourceinfo \
    -Dmetamaplite.ivf.cuisemantictypeindex=$PROJECTDIR/data/ivf/2018AA/USAbase/strict/indices/cuist \
    -Dmetamaplite.ivf.varsindex=$PROJECTDIR/data/ivf/2018AA/USAbase/strict/indices/vars \
