...
# BIOC=$HOME/.m2/repository/bioc/jbioc/1.1.2-SNAPSHOT/jbioc-1.1.2-SNAPSHOT.jar
...
# STAX2=$HOME/.m2/repository/org/codehaus/woodstox/stax2-api/3.1.1/stax2-api-3.1.1.jar
STAX2=/usr/local/pub/nlp/BioC/BioC_Java_1.0.1/lib/stax2-api-3.1.1.jar

JARSPATH=$ANALYZERS:$CORE:$QUERYPARSER:$OPENNLPTOOLS:$OPENNLPMAXENT:$BIOC:$NLP:$LOG4JAPI:$LOG4JCORE:$CONTEXT:$STAX2
...
echo java -cp $PROJECTDIR/target/classes:$JARSPATH $JVMOPTS gov.nih.nlm.nls.metamap.lite.BioCProcess $* 
java -cp $PROJECTDIR/target/classes:$JARSPATH $JVMOPTS gov.nih.nlm.nls.metamap.lite.BioCProcess $* 
